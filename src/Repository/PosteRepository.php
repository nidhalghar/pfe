...
class PosteRepository extends ServiceEntityRepository
{
    ...
    public function advanced_search($domaine, $addresse, $nomsocitie)
    {
        ...
        $sql = '
            ...
            WHERE p.domaine LIKE :domaine
            AND p.addresse LIKE :addresse
            AND u.nomsocitie LIKE :nomsocitie
        ';
